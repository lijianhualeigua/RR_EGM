...
class ABB_IRB6640Solver;

class ABB_IRB6640Solver : public virtual RobotRaconteur::RRObject
{
public:
...
virtual RR_SHARED_PTR<RobotRaconteur::RRArray<double > > set_joints(RR_SHARED_PTR<RobotRaconteur::RRArray<double > > seq, std::string dj) = 0;

virtual std::string RRType() {return "example.ABB_IRB6640.ABB_IRB6640Solver";  }
};
